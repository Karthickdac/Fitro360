...
- **RBAC**: gym_owner+manager manage devices and enrol; sales_executive may read; trainer may manually open door. Members may only see their own templates and entries.
- **Deferred (follow-up tasks)**: on-prem relay agent distributable, Phase B/C brand adapters (Suprema, Matrix, Anviz, Dahua, IDEMIA, Virdi, HID), GDPR retention sweeper job, websocket live feed, staff biometric clock-in.
